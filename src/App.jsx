...
function FloatingChat() {
  ...
  return (
    <>
      ...
      {open && (
        <div style={{ position: 'fixed', bottom: 104, right: 24, zIndex: 50, width: 320, borderRadius: 24, overflow: 'hidden', background: '#0a0a1a', border: '1px solid rgba(168,85,247,0.4)', boxShadow: '0 0 40px rgba(168,85,247,0.25)', animation: 'fadeIn 0.2s ease-out' }}>
